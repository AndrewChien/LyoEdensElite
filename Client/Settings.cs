...
namespace Client
{
    class Settings
    {
        public const long CleanDelay = 30000; // 600000;
        ...
        public const string DataPath = @".\Data\",
                            ...
                            EdensElitePath = @".\Data\EdensEliteData\";
        ...
        public static string P_BrowserAddress = "http://mir2.edens-elite.co.uk/PatcherImages/Image.png";
        public static string P_Client = Application.StartupPath + "\\";
        public static bool P_AutoStart = false;
        public static string ServerTimeZone = "GMT Standard Time";

        #region Custom
        public static string C_DonateLink = "http://mir2.edens-elite.co.uk/donation";
        public static string C_WebLink = "http://forums.edens-elite.co.uk/index.php";
        public static bool
                            MissIndicator = false,
        ...
        public static void Save()
        {
            ...
            Reader.Write("Game", "ServerTimeZone", ServerTimeZone);
            Reader.Write("Game", "MonsterName", MonsterName);//Ice
            Reader.Write("Game", "DropEffect", DropEffect); //Ice
            //Chat
