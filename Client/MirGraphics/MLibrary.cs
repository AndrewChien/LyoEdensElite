...
namespace Client.MirGraphics
{
    public static class Libraries
    {
        ...
        public static readonly MLibrary
            ...
            MobImage = new MLibrary(Settings.DataPath + "MobImage"),
            ...
            Magic10 = new MLibrary(Settings.DataPath + "Magic10"),
            HeroComboSpell = new MLibrary(Settings.DataPath + "HeroDualMagic"),
            AltDataMagic = new MLibrary(Settings.DataPath + "AltDataMagic"),
            ...
            EdensEliteInter = new MLibrary(Settings.EdensElitePath + "ee-inter"),
            CustomButtons = new MLibrary(Settings.EdensElitePath + "buttons"),
            CustomLoginScene = new MLibrary(Settings.EdensElitePath + "custom-login"),
            CustomCharsel = new MLibrary(Settings.EdensElitePath + "custom-char-sel"),
            CustomPrguse = new MLibrary(Settings.EdensElitePath + "custom-prguse"),
            CustomPrguse2 = new MLibrary(Settings.EdensElitePath + "custom-prguse2"),
            CustomTitle = new MLibrary(Settings.EdensElitePath + "custom-title"),
            FloorItemEffect = new MLibrary(Settings.EdensElitePath + "DropEffects"),
            M3MobMagic = new MLibrary(Settings.EdensElitePath + "MobMagic"),
            M3MobMagic1 = new MLibrary(Settings.EdensElitePath + "MobMagic1"),
            M3MobMagic2 = new MLibrary(Settings.EdensElitePath + "MobMagic2"),
            M3MobMagic3 = new MLibrary(Settings.EdensElitePath + "MobMagic3"),
            M3MobMagic4 = new MLibrary(Settings.EdensElitePath + "MobMagic4"),
            M3MobMagic5 = new MLibrary(Settings.EdensElitePath + "MobMagic5"),
            M3MobMagic6 = new MLibrary(Settings.EdensElitePath + "MobMagic6");
        ...
        public static readonly MLibrary[] CArmours = new MLibrary[100],
                                          CWeapons = new MLibrary[200],
                                          CHair = new MLibrary[9],
                                          CHelmet = new MLibrary[20],
                                          CHumEffect = new MLibrary[50],
                                          AArmours = new MLibrary[80],
                                          AWeaponsL = new MLibrary[80],
                                          AWeaponsR = new MLibrary[80],
                                          AHair = new MLibrary[9],
                                          AHumEffect = new MLibrary[40],
                                          ARArmours = new MLibrary[47],
                                          ...
                                          WeaponEffectLibraries = new MLibrary[200],
                                          LWeaponEffectLibraries = new MLibrary[200],
                                          RWeaponEffectLibraries = new MLibrary[200],
                                          AHelmet = new MLibrary[20],
                                          ...
                                          WingEffectLibrary = new MLibrary[200],
                                          WeaponEffectLibrary = new MLibrary[200];
        ...
        static Libraries()
        {
            ...
            for (int i = 0; i < CHelmet.Length; i++)
                CHelmet[i] = new MLibrary(Settings.CHelmetPath + i.ToString("00"));
            ...
            for (int i = 0; i < WeaponEffectLibraries.Length; i++)
                WeaponEffectLibraries[i] = new MLibrary(Settings.CWeaponEffectPath + i.ToString("00"));

            for (int i = 0; i < RWeaponEffectLibraries.Length; i++)
                RWeaponEffectLibraries[i] = new MLibrary(Settings.CWeaponEffectPath + i.ToString("00") + " R");

            for (int i = 0; i < LWeaponEffectLibraries.Length; i++)
                LWeaponEffectLibraries[i] = new MLibrary(Settings.CWeaponEffectPath + i.ToString("00") + " L");
            ...
            for (int i = 0; i < AHelmet.Length; i++)
                AHelmet[i] = new MLibrary(Settings.AHelmetPath + i.ToString("00"));
            ...
            for (int i = 0; i < WingEffectLibrary.Length; i++)
                WingEffectLibrary[i] = new MLibrary(Settings.EdensElitePath + @"WingEffects\" + i.ToString("00"));

            for (int i = 0; i < WeaponEffectLibrary.Length; i++)
                WeaponEffectLibrary[i] = new MLibrary(Settings.EdensElitePath + @"WeaponEffects\" + i.ToString("00"));
        ...
        static void LoadLibraries()
        {
            ...
            CustomButtons.Initialize();
            Progress++;

            CustomPrguse.Initialize();
            Progress++;

            CustomPrguse2.Initialize();
            Progress++;

            CustomTitle.Initialize();
            Progress++;

            FloorItemEffect.Initialize();
            Progress++;
        }
        ...
        private static void LoadGameLibraries()
        {
            Count = MapLibs.Length + Monsters.Length + Gates.Length + NPCs.Length + CArmours.Length +
                ...
                CHumEffect.Length + WeaponEffectLibraries.Length + AHumEffect.Length + ARHumEffect.Length + Mounts.Length + Fishing.Length + Pets.Length +
                Transform.Length + TransformMounts.Length + TransformEffect.Length + TransformWeaponEffect.Length + RWeaponEffectLibraries.Length + LWeaponEffectLibraries.Length + WingEffectLibrary.Length + WeaponEffectLibrary.Length;//   Add the length to end
            ...
            HeroComboSpell.Initialize();
            Progress++;
            AltDataMagic.Initialize();
            Progress++;
            ...
            M3MobMagic.Initialize();
            Progress++;
            M3MobMagic1.Initialize();
            Progress++;
            M3MobMagic2.Initialize();
            Progress++;
            M3MobMagic3.Initialize();
            Progress++;
            M3MobMagic4.Initialize();
            Progress++;
            M3MobMagic5.Initialize();
            Progress++;
            M3MobMagic6.Initialize();
            Progress++;
            ...
            for (int i = 0; i < WeaponEffectLibraries.Length; i++)
            {
                WeaponEffectLibraries[i].Initialize();
                Progress++;
            }

            for (int i = 0; i < RWeaponEffectLibraries.Length; i++)
            {
                RWeaponEffectLibraries[i].Initialize();
                Progress++;
            }

            for (int i = 0; i < LWeaponEffectLibraries.Length; i++)
            {
                LWeaponEffectLibraries[i].Initialize();
                Progress++;
            }
            ...
            for (int i = 0; i < WingEffectLibrary.Length; i++)
            {
                WingEffectLibrary[i].Initialize();
                Progress++;
            }
            for (int i = 0; i < WeaponEffectLibrary.Length; i++)
            {
                WeaponEffectLibrary[i].Initialize();
                Progress++;
            }
    ...
    {
        private const string Extention = ".Lib";//lib文件是保存图片数组（瓦片、贴图等）的资源库文件
        ...
        public string _DebugFileName { get { return _fileName; } }
        /// <summary>
        /// 图片数组
        /// </summary>
        ...
        /// <summary>
        /// V2版本的lib解包，顺序见LibraryViewer.MLibraryV2.Save()
        /// </summary>
        public void Initialize()
        {
            ...
            try
            {
                ...
                CurrentVersion = _reader.ReadInt32();//读1、读版本号
                ...
                _count = _reader.ReadInt32();//读2、读图片数量
                _images = new MImage[_count];
                _indexList = new int[_count];

                for (int i = 0; i < _count; i++)
                    _indexList[i] = _reader.ReadInt32();//读3、读每张图片的起始地址（偏移量）
        ...
        public void DrawBlend(int index, Rectangle section, Point point, Color colour, bool offSet, float rate = 1)
        {
            if (!CheckImage(index))
                return;
    ...
    public sealed class MImage
    {
        ...
        public unsafe void CreateTexture(BinaryReader reader)
        {
            ...
            {
                CMain.SaveError(string.Format("Error with Image : {0}", ex.ToString()));
            }
        }
