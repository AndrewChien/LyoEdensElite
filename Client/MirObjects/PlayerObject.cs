...
namespace Client.MirObjects
{
    public class PlayerObject : MapObject
    {
        ...
        public byte Helmet;
        public ushort Level;
        public ushort OrigLevel;
        public MLibrary WeaponLibrary1, WeaponLibrary2, HairLibrary, HelmetLibrary, WingLibrary, MountLibrary, WeaponEffectLibrary, WeaponEffectLibrary2;
        ...
        public ComboSpell comboSpell = new ComboSpell();
        ...
        public bool HumUp;
        public bool HasHero;
        public HeroState HeroState = HeroState.Unspawned;

        public bool IsGM;
        public bool IsDev;
        public bool ShowGMEffect;
        public uint CurrentHeroOBjectId;
        ...
        public void SetHeroObjectID(uint uid)
        {
            CurrentHeroOBjectId = uid;
        }
            ...
            if (GameScene.Hero != null)
            {
                for (int i = MapControl.Objects.Count - 1; i >= 0; i--)
                {
                    ...
                    if ((ob is PlayerObject) || (ob is MonsterObject))
                    {
                        ...
                        for (int x = 0; x < ob.Buffs.Count; x++)
                        {
                            ob.AddBuffEffect(ob.Buffs[x]);                            
                        }
                    }
                }
            }
        ...
        private void ResetFramePos(bool altAnim, int idx)
        {
            ...
            if (tempFrames != Frames && Frames.Frames.ContainsKey(CurrentAction))
            {
                DrawFrame = 0;
                DrawWingFrame = 0;
                FrameIndex = 0;
        ...
        public virtual void SetLibraries()
        {
            ...
            if (User != null &&
                User.Equipment[(int)EquipmentSlot.Helmet] != null)
            {
                ItemInfo tmp = GameScene.GetInfo(User.Equipment[(int)EquipmentSlot.Helmet].ItemIndex);
                if (tmp != null &&
                    Helmet != tmp.Shape)
                    Helmet = (byte)tmp.Shape;
            }
            bool altAnim = false;
            ...
            else
            {
                if (WeaponEffect > 0)
                {
                    WeaponEffectLibrary = Libraries.WeaponEffectLibraries[WeaponEffect];
                }
                        ...
                        else
                        {
                            ...
                            if (altAnim)
                            {
                                switch (Armour)
                                {
                                    ...
                                    case 19: // Ice 111/11
                                        BodyLibrary = Armour - 3 < Libraries.AArmours.Length ? Libraries.AArmours[Armour - 4] : Libraries.AArmours[0];
                                        break;
                                    ...
                                    case 42: //Grnheaven  //Ice
                                        BodyLibrary = Armour - 25 < Libraries.AArmours.Length ? Libraries.AArmours[Armour - 25] : Libraries.AArmours[0];
                                        break;

                                    case 43: //Redheaven  //Ice
                                        BodyLibrary = Armour - 26 < Libraries.AArmours.Length ? Libraries.AArmours[Armour - 25] : Libraries.AArmours[0];
                                        break;

                                    case 44: //Blkheaven  //Ice
                                        BodyLibrary = Armour - 27 < Libraries.AArmours.Length ? Libraries.AArmours[Armour - 25] : Libraries.AArmours[0];
                                        break;

                                    case 45: //RedDragon  //Ice
                                        BodyLibrary = Armour - 28 < Libraries.AArmours.Length ? Libraries.AArmours[Armour - 25] : Libraries.AArmours[0];
                                        break;

                                    case 46: //Colorfull  //Ice
                                        BodyLibrary = Armour - 29 < Libraries.AArmours.Length ? Libraries.AArmours[Armour - 25] : Libraries.AArmours[0];
                                        break;

                                    case 55: //Black mir armour
                                        BodyLibrary = 31 < Libraries.AArmours.Length ? Libraries.AArmours[31] : Libraries.AArmours[0];
                                        break;

                                    case 66: //Shanda Armour Set Red  //Ice
                                        BodyLibrary = 25 < Libraries.AArmours.Length ? Libraries.AArmours[25] : Libraries.AArmours[0];
                                        break;

                                    case 67: //Shanda Armour Set Blue //Ice
                                        BodyLibrary = 26 < Libraries.AArmours.Length ? Libraries.AArmours[26] : Libraries.AArmours[0];
                                        break;

                                    case 68: //Shanda Armour Set Golden  //Ice
                                        BodyLibrary = 27 < Libraries.AArmours.Length ? Libraries.AArmours[27] : Libraries.AArmours[0];
                                        break;

                                    case 69: //Shanda Armour Set Norm //Ice
                                        BodyLibrary = 24 < Libraries.AArmours.Length ? Libraries.AArmours[24] : Libraries.AArmours[0];
                                        break;

                                    case 70: // Shanda Armour
                                        BodyLibrary = 29 < Libraries.AArmours.Length ? Libraries.AArmours[29] : Libraries.AArmours[0];
                                        break;

                                    case 71: //IceRobe  //Ice
                                        BodyLibrary = 22 < Libraries.AArmours.Length ? Libraries.AArmours[22] : Libraries.AArmours[0];
                                        break;

                                    case 72: //IceRobe  //Ice
                                        BodyLibrary = 28 < Libraries.AArmours.Length ? Libraries.AArmours[28] : Libraries.AArmours[0];
                                        break;

                                    case 73: //GoldenHeaven  //Ice
                                        BodyLibrary = 23 < Libraries.AArmours.Length ? Libraries.AArmours[23] : Libraries.AArmours[0];
                                        break;

                                    case 74: // Shanda Armour
                                        BodyLibrary = 30 < Libraries.AArmours.Length ? Libraries.AArmours[30] : Libraries.AArmours[0];
                                        break;

                                    case 75: // Shanda Armour
                                        BodyLibrary = 32 < Libraries.AArmours.Length ? Libraries.AArmours[32] : Libraries.AArmours[0];
                                        break;

                                    case 76: // Shanda Armour
                                        BodyLibrary = 33 < Libraries.AArmours.Length ? Libraries.AArmours[33] : Libraries.AArmours[0];
                                        break;

                                    case 77: // Shanda Armour
                                        BodyLibrary = 34 < Libraries.AArmours.Length ? Libraries.AArmours[34] : Libraries.AArmours[0];
                                        break;

                                    case 78: // Shanda Armour
                                        BodyLibrary = 35 < Libraries.AArmours.Length ? Libraries.AArmours[35] : Libraries.AArmours[0];
                                        break;
                            ...
                            if (HasClassWeapon)
                            {
                                ...
                                if (WeaponEffect > 0)
                                {
                                    WeaponEffectLibrary = Libraries.LWeaponEffectLibraries[WeaponEffect];
                                    WeaponEffectLibrary2 = Libraries.RWeaponEffectLibraries[WeaponEffect];
                                }
                                else
                                {
                                    WeaponEffectLibrary = null;
            ...
            if (Helmet > 0 && User.Class != MirClass.Assassin)  //Gotta add Assassin folder in.
                HelmetLibrary = Helmet < Libraries.CHelmet.Length ? Libraries.CHelmet[Helmet - 1] : null;
            else if (Helmet > 0 && User.Class == MirClass.Assassin)
                HelmetLibrary = Helmet < Libraries.AHelmet.Length ? Libraries.AHelmet[Helmet - 1] : null;
        ...
        public virtual void SetEffects()
        {
            ...
            long delay = 5000;
            if ((IsDev || IsGM) && ShowGMEffect)
            {
                if (IsDev)
                    Effects.Add(new SpecialEffect(Libraries.Effect, 1278, 7, 3600, this, true, false, 1) { Repeat = true });
                else if (IsGM)
                    Effects.Add(new SpecialEffect(Libraries.Effect, 1271, 7, 3600, this, true, false, 1) { Repeat = true });
            }


            if (LevelEffects == LevelEffects.None)
                return;
        ...
        {
            //关于客户端行走动画：
            //逻辑比较复杂，其中的核心变量是 Movement 和 OffSetMove，下面我们分别进行解释：
            ...
            //这里的 Movement 用于在屏幕上正确的绘制玩家，当 PlayerObject 代表当前玩家时，即 this == User，Movement 与 User.Movement 是相等的，
            //DrawLocation 始终位于屏幕的中心区域，而当 PlayerObject 代表其他玩家时，我们需要计算出其他玩家相对于用户的距离，
            //即通过 Movement -UserMovement，此外别忘了 Movement 只代表移动前的位置，如果用户在移动中，还需要将这个距离叠加上 - OffSetMove 来进行插值。
            //而 OffSetMove 一方面用于绘制其他玩家，另一方面则用于绘制地图，传奇的地图渲染逻辑是我不动世界在动，
            //即角色移动的本质是地图产生反向位移


            //首先在 PlayerObject 的 Process 中处理 Frame Update，随后处理角色的位移插值，这部分逻辑位于 Process 调用完 ProcessFrames 之后的部分
        ...
        {
            //UserObject 并不直接处理 Action，而是只处理从用户输入产生 QueuedAction 到 QueuedAction 加入到行为队列这一过程，
            //实际的行为处理逻辑在其父类 PlayerObject 中处理
            //当行为队列为空时，会设置当前行为 CurrentAction 为 Standing，否则从队列中取出第一个行为设置到当前。
            //总的来说，用户的当前行为取决于 CurrentAction，当行为队列为空时，CurrentAction 会被设置为 Idle 类状态，
            //否则会从队列中依次取出行为执行，那么哪些行为会引起 ActionFeed 被消费（即调用 SetAction）呢？
            //除了上述提到的 UserObject 的 QueuedAction 不为空，另一个比较直观的就是当前动作执行完成，即帧动画播放完毕

            //我们以角色移动为例分析行为系统的工作过程，在网络游戏中，角色移动是一个较为复杂的逻辑，其核心逻辑包括:
            //1角色在地图上的移动需要与帧动画保持同步，需要将实际的位移按照动画帧进行插值；
            //2需要限制客户端的移动频率，避免服务端和客户端的位置产生极大偏差，这一频率还应当跟随网络延迟进行变化；
            //3当客户端与服务端的角色位置不同步时，需要将客户端位置与服务单进行强制同步。

            //当用户通过鼠标触发移动时，会将一个 Walking Action 插入到 ActionFeed 并调用 SetAction 方法，在这里我们会取出 Action 直接更新角色的位置和方向
            ...
            if (ActionFeed.Count == 0)
            {
                ...
                CurrentAction = CMain.Time > comboSpell.Delay ? CurrentAction : MirAction.Stance2;
            ...
            else
            {
                ...
                switch (CurrentAction)
                {
                    ...
                    case MirAction.Attack4:
                        ...
                        Frames.Frames.TryGetValue(Spell == Spell.TwinDrakeBlade || Spell == Spell.SliceNDice || Spell == Spell.FlamingSword || Spell == Spell.BlazingSword ? MirAction.Attack1 : CurrentAction, out Frame);
                        break;
                    case MirAction.Spell:
                        Spell = (Spell)action.Params[0];
                        switch (Spell)
                        {
                            ...
                            case Spell.CounterAttack:
                                ...
                                if (this == User)
                                {
                                    ...
                                    GameScene.OrigAttackTime = Math.Min(long.MaxValue, GameScene.AttackTime * 30 / 100);
                ...
                if (this == User)
                {
                    switch (CurrentAction)
                    {
                        ...
                        case MirAction.Sneek:
                            ...
                            GameScene.OrigLastRun = Math.Min(long.MaxValue, GameScene.LastRunTime * 30 / 100);
                            Network.Enqueue(new C.Walk { Direction = Direction });// 发送 Walking Packet 到服务端
                            GameScene.Scene.MapControl.FloorValid = false;
                            GameScene.CanRun = true;
                            MapControl.NextAction = CMain.Time + 2500;// 在服务端没有回复 ACK 的情况下，每 2500ms 只能执行一次 Walking
                            break;
                        case MirAction.Running:
                        case MirAction.MountRunning:
                            GameScene.LastRunTime = CMain.Time;
                        ...
                        case MirAction.MountAttack:
                            ...
                            if (!RidingMount)
                            {
                                ...
                                if (GameScene.Thrusting && GameScene.Scene.MapControl.HasTarget(Functions.PointMove(CurrentLocation, Direction, 2), true))
                                ...
                                if (GameScene.SliceNDice && TargetObject != null)
                                {
                                    magic = User.GetMagic(Spell.SliceNDice);
                                    if (magic != null)
                                        Spell = Spell.SliceNDice;
                                }
                                ...
                                if (GameScene.BlazingSword)
                                {
                                    if (TargetObject != null)
                                    {
                                        magic = User.GetMagic(Spell.BlazingSword);
                                        if (magic != null)
                                            Spell = Spell.BlazingSword;
                                    }
                                }
                                if (GameScene.CresSlash)
                                {
                                    if (TargetObject != null || GameScene.Scene.MapControl.CanCrescentSlash(CurrentLocation, Direction))
                                    {
                                        magic = User.GetMagic(Spell.CrescentSlash);
                                        if (magic != null && magic.BaseCost + magic.LevelCost * magic.Level <= User.MP)
                                        {
                            ...
                            if (Spell == Spell.SliceNDice)
                                GameScene.SliceNDice = false;
                            if (Spell == Spell.FlamingSword)
                                GameScene.FlamingSword = false;
                            if (Spell == Spell.BlazingSword)
                                GameScene.BlazingSword = false;
                    ...
                    case MirAction.Attack1:
                        ...
                        switch (Spell)
                        {
                            ...
                            case Spell.DoubleSlash:
                                FrameInterval = (FrameInterval * 6 / 10); // was 7
                                EffectFrameInterval = (EffectFrameInterval * 6 / 10);// was 7
                                action = new QueuedAction { Action = MirAction.Attack4, Direction = Direction, Location = CurrentLocation, Params = new List<object>() };
                    ...
                    case MirAction.Attack4:
                        ...
                        switch (Spell)
                        {
                            ...
                            case Spell.FlashDash:
                                ...
                                float attackRate = (float)(attackDelay / 600F * 10F);
                                FrameInterval = FrameInterval * (int)attackRate / 20;
                                EffectFrameInterval = EffectFrameInterval * (int)attackRate / 20;
                                break;
                            case Spell.SliceNDice:
                                FrameInterval = FrameInterval * 3 / 10;
                                EffectFrameInterval = EffectFrameInterval * 3 / 10;
                                break;
                        }
                        break;
                    case MirAction.Struck:
                    ...
                    case MirAction.Spell:
                        ...
                        switch (Spell)
                        {
                            ...
                            case Spell.FireSpray:
                                Effects.Add(new Effect(Libraries.Magic10, 1568, 12, Frame.Count * FrameInterval, this));
                                SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                break;
                            ...
                            case Spell.DragonFlames:
                                Effects.Add(new Effect(Libraries.HeroComboSpell, 540, 10, Frame.Count * FrameInterval, this));

                                comboSpell.Delay = CMain.Time + 2000;
                                comboSpell.Duration = 2000;
                                comboSpell.Spell = Spell.DragonFlames;
                                break;

                            #endregion

                            #region BrokenSoulCut

                            case Spell.BrokenSoulCut:
                                Effects.Add(new Effect(Libraries.HeroComboSpell, 170, 5, Frame.Count * FrameInterval, this));

                                comboSpell.Delay = CMain.Time + 2000;
                                comboSpell.Duration = 2000;
                                comboSpell.Spell = Spell.BrokenSoulCut;
                                break;
                            ...
                            case Spell.SoulReaper:
                                Effects.Add(new Effect(Libraries.HeroComboSpell, 866, 7, Frame.Count * FrameInterval, this));

                                comboSpell.Delay = CMain.Time + 2000;
                                comboSpell.Duration = 2000;
                                comboSpell.Spell = Spell.SoulReaper;
                                break;

                            #endregion

                            #region LastJudgement

                            case Spell.LastJudgement:
                                Effects.Add(new Effect(Libraries.HeroComboSpell, 210, 10, Frame.Count * FrameInterval, this));

                                comboSpell.Delay = CMain.Time + 2000;
                                comboSpell.Duration = 2000;
                                comboSpell.Spell = Spell.LastJudgement;
                                break;
                            ...
                            case Spell.ThunderClap:
                                Effects.Add(new Effect(Libraries.HeroComboSpell, 290, 10, Frame.Count * FrameInterval, this));

                                comboSpell.Delay = CMain.Time + 2000;
                                comboSpell.Duration = 2000;
                                comboSpell.Spell = Spell.ThunderClap;
                                break;
                            ...
                            case Spell.ChopChopStar:
                                Effects.Add(new Effect(Libraries.HeroComboSpell, 460, 10, Frame.Count * FrameInterval, this));

                                comboSpell.Delay = CMain.Time + 2000;
                                comboSpell.Duration = 2000;
                                comboSpell.Spell = Spell.ChopChopStar;
                                break;

                            #endregion

                            #region SoulEaterSwamp

                            case Spell.SoulEaterSwamp:
                                Effects.Add(new Effect(Libraries.HeroComboSpell, 610, 10, Frame.Count * FrameInterval, this));

                                comboSpell.Delay = CMain.Time + 2000;
                                comboSpell.Duration = 2000;
                                comboSpell.Spell = Spell.SoulEaterSwamp;
                                break;
                            ...
                            case Spell.HandOfGod:
                                Effects.Add(new Effect(Libraries.HeroComboSpell, 897, 16, Frame.Count * FrameInterval, this));

                                comboSpell.Delay = CMain.Time + 2000;
                                comboSpell.Duration = 2000;
                                comboSpell.Spell = Spell.HandOfGod;
                                break;
                            ...
                            case Spell.ShadowStep:
                                Effects.Add(new Effect(Libraries.AltDataMagic, 2090, 7, Frame.Count * FrameInterval, this));
                                SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                break;
                            #endregion
                            ...
                            #region MoonMist
                            case Spell.MoonMist:
                                Effects.Add(new Effect(Libraries.Magic3, 680, 15, Frame.Count * FrameInterval, this) { Repeat = true, RepeatUntil = CMain.Time + 8000, spell = Spell.MoonMist });
                                SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                BlizzardStopTime = CMain.Time + 8000;
                                break;
                            #endregion
                            ...
                            case Spell.SummonShinsu:
                                ...
                                if (magic != null) SpellLevel = magic.Level;
                                {
                                    ...
                                    switch (SpellLevel)
                                    {
                                        ...
                                        case 1: //Level 1
                                            Effects.Add(new Effect(Libraries.Magic2, 2790, 10, Frame.Count * FrameInterval, this));
                                            SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                            break;

                                        case 2: //Level 2
                                            Effects.Add(new Effect(Libraries.Magic2, 2804, 10, Frame.Count * FrameInterval, this));
                                            SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                            break;

                                        case 3: //Level 3
                                            Effects.Add(new Effect(Libraries.Magic2, 2818, 10, Frame.Count * FrameInterval, this));
                                            SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                            break;
                                    }
                                }
                            ...
                            case Spell.FastMove:
                                Effects.Add(new Effect(Libraries.Magic3, 3450, 10, 10 * EffectFrameInterval, this));
                                break;
                            ...
                            case Spell.LavaKing:
                                Effects.Add(new Effect(Libraries.AltDataMagic, 1862, 40, 1800, this));
                                //MapControl.Effects.Add(new Effect(Libraries.AltDataMagic, 2025, 24, 2000, User.FRCastLocation));
                                SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                if (!FastChannel)
                                    BlizzardStopTime = CMain.Time + 3200;
                                break;
                            ...
                            case Spell.BladeStorm:
                                MapControl.Effects.Add(new Effect(Libraries.AltDataMagic, 1946, 11, 1000, CurrentLocation));
                                SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                break;
                            ...
                            case Spell.FrozenRains:
                                Effects.Add(new Effect(Libraries.AltDataMagic, 0, 8, 1800, this));
                                //Effects.Add(new Effect(Libraries.AltDataMagic, 35, 8, 2000, this) { Start = CMain.Time + 2000 });
                                if (!FastChannel)
                                    BlizzardStopTime = CMain.Time + 3200;
                                break;
                            ...
                            case Spell.CounterAttack:
                                ...
                                Effects.Add(new Effect(Libraries.Magic3, 130, 8, 8 * FrameInterval, this));
                                break;
                            ...
                            case Spell.CrescentSlash:
                                //2626 + ((int)Direction * 20) + FrameIndex, DrawLocation, Color.White, true, 0.7F);
                                Effects.Add(new Effect(Libraries.Magic2, 2626 + ((int)Direction * 20) + FrameIndex, 20, 20 * FrameInterval, this));
                                SoundManager.PlaySound(20000 + (ushort)Spell * 10 + (Gender == MirGender.Male ? 0 : 1));
                            ...
                            case Spell.FuryWaves:
                                ...
                                if (magic != null) SpellLevel = magic.Level;
                                {
                                    ...
                                    {
                                        case 0: //No Purple
                                            Effects.Add(new Effect(Libraries.AltDataMagic, 770 + (int)Direction * 20, 12, 12 * FrameInterval, this));
                                            Effects.Add(new Effect(Libraries.AltDataMagic, 938 + (int)Direction * 20, 14, 14 * FrameInterval, this));
                                            SoundManager.PlaySound(20000 + (ushort)Spell * 10 + (Gender == MirGender.Male ? 0 : 1));
                                            break;

                                        case 1: //No Blue
                                            Effects.Add(new Effect(Libraries.AltDataMagic, 308 + (int)Direction * 20, 12, 12 * FrameInterval, this));
                                            Effects.Add(new Effect(Libraries.AltDataMagic, 1106 + (int)Direction * 20, 14, 14 * FrameInterval, this));
                                            SoundManager.PlaySound(20000 + (ushort)Spell * 10 + (Gender == MirGender.Male ? 0 : 1));
                                            break;

                                        case 2: //Purple/Blue
                                            Effects.Add(new Effect(Libraries.AltDataMagic, 462 + (int)Direction * 20, 12, 12 * FrameInterval, this));
                                            Effects.Add(new Effect(Libraries.AltDataMagic, 1274 + (int)Direction * 20, 14, 14 * FrameInterval, this));
                                            SoundManager.PlaySound(20000 + (ushort)Spell * 10 + (Gender == MirGender.Male ? 0 : 1));
                                            break;

                                        case 3: //Purple/Blue ziggy
                                            Effects.Add(new Effect(Libraries.AltDataMagic, 616 + (int)Direction * 20, 12, 12 * FrameInterval, this));
                                            Effects.Add(new Effect(Libraries.AltDataMagic, 1442 + (int)Direction * 20, 14, 14 * FrameInterval, this));
                                            SoundManager.PlaySound(20000 + (ushort)Spell * 10 + (Gender == MirGender.Male ? 0 : 1));
                                            break;
                                    }
                                }
                            ...
                            case Spell.DragNet:
                                ...
                                if (magic != null) SpellLevel = magic.Level;
                                {
                                    ...
                                    switch (SpellLevel)
                                    {
                                        case 0:
                                        case 1:
                                            Effects.Add(new Effect(Libraries.AltDataMagic, 2004, 21, 1800, this));
                                            SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                            break;

                                        case 2:
                                        case 3:
                                            Effects.Add(new Effect(Libraries.AltDataMagic, 2049, 26, 1800, this));
                                            SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                            break;
                                    }
                                }
            ...
            OrigNextMotion = Math.Min(long.MaxValue, NextMotion * 30 / 100);
            NextMotion2 = CMain.Time + EffectFrameInterval;
            OrigNextMotion2 = Math.Min(long.MaxValue, NextMotion2 * 30 / 100);
        ...
        public virtual void ProcessFrames()
        {
            ...
            switch (CurrentAction)
            {
                ...
                case MirAction.Sneek:
                case MirAction.DashAttack:
                    if (!GameScene.CanMove) return;//控制移动帧率
                        ...
                        if (UpdateFrame() >= Frame.Count)
                        {
                            if (Cast)
                            {
                                ...
                                switch (Spell)
                                {
                                    ...
                                    case Spell.HeadShot:
                                        SoundManager.PlaySound(20000 + (ushort)Spell * 10 + 1);
                                        missile = CreateProjectile(1680, Libraries.AltDataMagic, true, 3, 30, 7);
                                        ...
                                        if (missile.Target != null)
                                        {
                                            ...
                                            {
                                                if (missile.Target.CurrentAction == MirAction.Dead) return;
                                                missile.Target.Effects.Add(new Effect(Libraries.AltDataMagic, 1960, 5, 600, missile.Target));
                                                SoundManager.PlaySound(20000 + (ushort)Spell.HeadShot * 10 + 2);
                                            };
                                        }
                                        break;
                                    ...
                                    #region Yin/Yang Tiger

                                    case Spell.YinYangTiger:
                                        SoundManager.PlaySound(20000 + (ushort)Spell * 10 + 1);
                                        missile = CreateProjectile(2075, Libraries.AltDataMagic, true, 5, 30, 5);
                                        ...
                                        if (missile.Target != null)
                                        {
                                            ...
                                            {
                                                if (missile.Target.CurrentAction == MirAction.Dead) return;
                                                missile.Target.Effects.Add(new Effect(Libraries.AltDataMagic, 2260, 10, 600, missile.Target));
                                                SoundManager.PlaySound(20000 + (ushort)Spell.SoulFireBall * 10 + 2);
                                            };
                                        }
                                        break;
                                    ...
                                    case Spell.SoulShield:
                                        SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                        missile = CreateProjectile(1160, Libraries.Magic, true, 3, 30, 7, 3, Color.Blue);
                                        missile.Explode = true;

                                        missile.Complete += (o, e) =>
                                        {
                                            MapControl.Effects.Add(new Effect(Libraries.Magic, 1320, 15, 1200, TargetPoint) {  Light = 4, LightColour = Color.Blue });
                                    ...
                                    case Spell.BlessedArmour:
                                        SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                        missile = CreateProjectile(1160, Libraries.Magic, true, 3, 30, 7, 3, Color.Red);
                                        missile.Explode = true;

                                        missile.Complete += (o, e) =>
                                        {
                                            MapControl.Effects.Add(new Effect(Libraries.Magic, 1340, 15, 1200, TargetPoint) { Light = 4, LightColour = Color.Red });
                                    ...
                                    case Spell.HolyShield:
                                        SoundManager.PlaySound(20000 + (ushort)Spell * 10 + 1);
                                        missile = CreateProjectile(4870, Libraries.Magic3, true, 6, 60, 4);
                                        missile.Explode = true;

                                        missile.Complete += (o, e) =>
                                        {
                                            MapControl.Effects.Add(new Effect(Libraries.Magic3, 5030, 26, 800, TargetPoint) { Light = 4, LightColour = Color.Yellow });
                                            SoundManager.PlaySound(20000 + (ushort)Spell.SoulFireBall * 10 + 2);
                                        };
                                        break;
                                    ...
                                    case Spell.DragNet:
                                        ...
                                        MapControl.Effects.Add(new Effect(Libraries.AltDataMagic, 2049, 26, 1800, TargetPoint));
                                        SoundManager.PlaySound(20000 + (ushort)Spell * 10);
                                        break;
                ...
                case MirAction.Attack1:
                    switch (Spell)
                    {
                        ...
                        case Spell.DoubleSlash:
                            ...
                            break;
                        case Spell.PoisonSword:
                            Libraries.Magic2.DrawBlend(2490 + ((int)Direction * 10) + FrameIndex, DrawLocation, Color.White, true, 0.7f);
                            break;
                        case Spell.Thrusting:
                        ...
                        case Spell.CrossHalfMoon:
                            switch (SpellLevel)
                            {
                                ...
                                case 2:
                                case 3:
                                    Libraries.AltDataMagic.DrawBlend(1596 + ((int)Direction * 10) + FrameIndex, DrawLocation, Color.White, true, 0.7F);
                                    break;
                                case 4:
                                case 5:
                                    Libraries.AltDataMagic.DrawBlend(224 + ((int)Direction * 10) + FrameIndex, DrawLocation, Color.White, true, 0.7F);
                                    break;
                            }
                            break;
                        case Spell.FlamingSword:
                            ...
                            break;
                        case Spell.SliceNDice:
                            Libraries.Magic10.DrawBlend(1590 + ((int)Direction * 10) + FrameIndex, DrawLocation, Color.White, true, 0.7F);
                            break;
                        case Spell.BlazingSword:
                            Libraries.AltDataMagic.DrawBlend(84 + ((int)Direction * 17) + FrameIndex, DrawLocation, Color.White, true, 0.7F);
                            break;
                        case Spell.CrescentSlash:
                            if (TargetObject != null || GameScene.Scene.MapControl.CanCrescentSlash(CurrentLocation, Direction))
                            {
                                Libraries.Magic2.DrawBlend(2626 + ((int)Direction * 20) + FrameIndex, DrawLocation, Color.White, true, 0.7F);
                                
                            }
                            //Effects.Add(new Effect(Libraries.Magic2, 2624 + (int)Direction * 20, 14, 800, this) { Blend = true });
                            break;
                    }
                    break;
                case MirAction.Attack4:
        ...
        public void DrawHat()
        {
            ...
            if (HelmetLibrary != null)
                HelmetLibrary.Draw(DrawFrame, DrawLocation, DrawColour, true);
        ...
        public void DrawWeapon()
        {
            ...
            {
                if (WeaponEffect > 0 && WeaponEffectLibrary != null)
                {
                    if (Class == MirClass.Assassin)
                        WeaponEffectLibrary.DrawBlend(DrawFrame, DrawLocation, DrawColour, true);
                    else
                        WeaponEffectLibrary.DrawBlend(DrawFrame + WeaponOffSet, DrawLocation, DrawColour, true);
                }
            }
        ...
        public void DrawWeapon2()
        {
            ...
            if (Settings.DropEffect)
            {
                if (WeaponEffect > 0 && WeaponEffectLibrary2 != null)
                {
                    if (Class == MirClass.Assassin)
                        WeaponEffectLibrary2.DrawBlend(DrawFrame, DrawLocation, DrawColour, true);
                    else
                        WeaponEffectLibrary2.DrawBlend(DrawFrame + WeaponOffSet, DrawLocation, DrawColour, true);
                }
            }
        ...
        public void DrawWings()
        {
            ...
            if (WingLibrary != null)
            {
                ...
                //GameScene.Scene.ChatDialog.ReceiveChat(DrawWingFrame.ToString(), ChatType.Hint);
            }
        }
        ...
        public void DrawMount()
        {
            ...
            {
                int offSet = HumUp ? 792 : 416;
                int NewDrawFrame = DrawFrame;

                if (HumUp)
                {
                    if (CurrentAction == MirAction.MountStanding)
                        NewDrawFrame = NewDrawFrame - (4 * (int)Direction);
                    if (CurrentAction == MirAction.MountWalking)
                        NewDrawFrame = NewDrawFrame - 32;
                    if (CurrentAction == MirAction.MountRunning)
                        NewDrawFrame = NewDrawFrame - 32 - (2 * (int)Direction);
                    if (CurrentAction == MirAction.MountStruck)
                        NewDrawFrame = NewDrawFrame - 48 - (5 * (int)Direction);
                }

                MountLibrary.Draw(NewDrawFrame - offSet + MountOffset, DrawLocation, DrawColour, true);
            }
        }
        ...
        public override void CreateLabel()
        {
            ...
            if (txt.Contains("_"))
            {
                ...
                if (names != null && names.Length > 1)
                {
                    ...
                    {
                        if (LabelList[i].Text != names[1] || LabelList[i].ForeColour != NameColour) continue;
                    ...
                    for (int i = 0; i < LabelList.Count; i++)
                    {
                        if (LabelList[i].Text != names[0] || LabelList[i].ForeColour != NameColour) continue;
            ...
            NameLabel = new MirLabel
            {
                ...
                OutLine = true,
                OutLineColour = OutLine_Colour == null ? Color.Black : OutLine_Colour,
                Text = Name,
            };
