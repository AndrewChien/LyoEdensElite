...
{
    /// <summary>
    /// 地图上会有哪些对象呢？我们通过查找所有继承 MapObject 的类可以得到：
    ...
    public abstract class MapObject
    {
        ...
        //  +# % damage ontop of when Attacking
        public ushort[] ElementsPos = new ushort[]
            {
                0,
                0,
                0,
        ...
        //  +# % damage ontop when taking damage
        public ushort[] ElementsNeg = new ushort[]
            {
                0,
                0,
                0,
        ...
        public Color TempOutlineColour = Color.Black;
        ...
        public short PotHPBoost = 0, PotMPBoost = 0;
        ...
        public bool isLastHitterHero = false;
        ...
        public virtual HeroMode HMode { get; set; }
        public bool InSafeZone { get => inSafeZone || CurrentMap.Info.SafeZone; set => inSafeZone = value; }
        ...
        public bool HasWallBetween(Point target)
        {
            ...
            while (location != target)
            {
                ...
                if (!CurrentMap.GetCell(location).HasWall) return false;
        ...
        public virtual void Spawned()
        {
            ...
            if ((Race == ObjectType.Monster || Race == ObjectType.Hero) && Settings.Multithreaded)
            {
        ...
        public virtual void Despawn()
        {
            ...
            if (Settings.Multithreaded && (Race == ObjectType.Monster || Race == ObjectType.Hero))
            {
        ...
        public abstract void ReceiveChat(string text, ChatType type, List<UserItem> items = null);
        ...
        {
            if (!CurrentMap.ValidPoint(CurrentLocation))
                return false;
        ...
        public void BroadcastHealthChange()
        {
            ...
            if (Envir.Time < RevTime || Race == ObjectType.Hero)
            {
            ...
            {
                //  Create a temporary Object to call it's values
                MonsterObject tmp = (MonsterObject)this;
                //  Not a Boss, not set for Auto Rev and no master
                if (!tmp.Info.IsBoss &&
                    !AutoRev &&
                    Master == null)
                {
            ...
            //  We'll need this for the Party Status dialog :D
